	...
	<main id="MAIN_CONTENTS">
		<header>
			...
			<ul>
				...
				<li>
					Primary programming language: <a id="marked2" href="https://svelte.dev/">Svelte</a>
					and
					<a id="marked3" href="https://sass-lang.com/">SCSS</a>
				</li>

				<li>
					Currently learning <a id="marked5" href="https://rust-lang.org"> Rust </a>
				</li>
		...
		<div>
			...
			<div>
				...
				<ul>
					<li>Videoediting</li>
					<li>
						Experimenting with Linux (Specifically <a id="marked4" href="https://nixos.org/"
							>NixOS</a
						>)
					</li>
